...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to momod "gobject list" output
    ...
    def momod_serialise(self):
        import momolib
        return momolib.SHIM_serialise_for_momod(self.serialise())
